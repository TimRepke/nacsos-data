...
@ensure_session_async
async def read_task_by_id(session: DBSession, task_id: str | uuid.UUID) -> TaskModel | None:
...
@ensure_session_async
async def read_num_tasks_for_fingerprint(session: DBSession, fingerprint: str) -> int:
...
@ensure_session_async
async def check_fingerprint_exists(session: DBSession, fingerprint: str) -> bool:
    return await read_num_tasks_for_fingerprint(fingerprint=fingerprint, session=session) > 0


@ensure_session_async
async def check_task_id_exists(session: DBSession, task_id: str | uuid.UUID) -> bool:
...
@ensure_session_async
async def read_task_status_by_id(session: DBSession, task_id: str | uuid.UUID) -> TaskStatus | str | None:
...
@ensure_session_async
async def delete_task_by_id(session: DBSession, task_id: str | uuid.UUID) -> None:
...
@ensure_session_async
async def delete_tasks_by_fingerprint(session: DBSession, fingerprint: str) -> None:
...
@ensure_session_async
async def reset_failed(session: DBSession) -> None:
...
@ensure_session_async
async def update_status(session: DBSession, task_id: str | uuid.UUID, status: TaskStatus) -> None:
